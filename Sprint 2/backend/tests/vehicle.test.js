...
test('testing createVehicle', async () => {
  const createdVehicle = await VehicleDB.createVehicle(
    'Subaru Impreza',
    'Hatchback',
    'Manual',
    '5',
  ...
  expect(createdVehicle.url).toBe(
    'https://www.youtube.com/watch?v=xm3YgoEiEDc'
  )
...
test('testing findAllVehicles', async () => {
  const createdVehicle1 = await VehicleDB.createVehicle(
    'Subaru Impreza',
    'Hatchback',
    'Manual',
    '5',
  ...
  const createdVehicle2 = await VehicleDB.createVehicle(
    'Tesla Model S',
    'Sedan',
    'Automatic',
    '4',
...
test('testing updateVehicle', async () => {
  ...
  const updatedVehicle = await VehicleDB.updateVehicle(
    createdVehicle._id,
    'Subaru Impreza',
    'Hatchback',
    'Manual',
...
test('testing deleteVehicle', async () => {
  ...
  const deletedVehicle = await VehicleDB.deleteVehicle(createdVehicle._id)
