...
test("testing createUser", async () => {
  createdUser = await UserDB.createUser(
    "John",
    "Doe",
    "admin",
    "email",
...
test("testing findAllUsers", async () => {
  createdUser1 = await UserDB.createUser(
    "John1",
    "Doe",
    "admin",
    "email",
  ...
  createdUser2 = await UserDB.createUser(
    "John2",
    "Doe",
    "admin",
    "email",
...
test("testing updateUser", async () => {
  ...
  updatedUser = await UserDB.updateUser(
    createdUser._id,
    "Jane",
    "Doe",
    "admin",
...
test("testing deleteUser", async () => {
  ...
  deletedUser = await UserDB.deleteUser(createdUser._id);
