...
test("testing createBranch", async () => {
  branch = await BranchDB.createBranch("locationName", "0123123", "5435432");
...
test("testing findAllBranches", async () => {
  createdBranch1 = await BranchDB.createBranch(
    "locationName1",
    "0123123",
    "5435432"
  );

  createdBranch2 = await BranchDB.createBranch(
    "locationName2",
    "0123123",
    "5435432"
  );
...
test("testing findBranchById", async () => {
  createdBranch = await BranchDB.createBranch(
    "locationName",
    "0123123",
    "5435432"
  );
...
test("testing deleteBranch", async () => {
  createBranch = await BranchDB.createBranch(
    "locationName",
    "0123123",
    "5435432"
  );

  deletedBranch = await BranchDB.deleteBranch(createBranch._id);
