...
export default function ModifyVehicles() {
  ...
  function handleSubmit(event: React.FormEvent, newVehicleInfo) {
    ...
    axios
      .post("http://localhost:8080/updateVehicle", newVehicleInfo)
      .then((res) => {
        if (res.status === 200) {
          console.log(res);
      ...
      <>
        <tr>
          <td className="hiddenForm">
            <form
              id={vehicleInfo._id}
              onSubmit={(e) => handleSubmit(e, updatedVehicleInfo)}
            />
          </td>
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.model}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="model"
              onChange={(e) => (updatedVehicleInfo.model = e.target.value)}
              autoComplete="off"
            />
          </td>
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.type}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="type"
              onChange={(e) => (updatedVehicleInfo.type = e.target.value)}
              autoComplete="off"
            />
          </td>
          <td className="fieldInputs">
          ...
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.numberOfSeats}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="numberOfSeats"
              onChange={(e) =>
                (updatedVehicleInfo.numberOfSeats = e.target.value)
              }
              autoComplete="off"
            />
          </td>
          ...
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.url}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="url"
              onChange={(e) => (updatedVehicleInfo.url = e.target.value)}
              autoComplete="off"
            />
          </td>
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.rentalPrice}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="rentalPrice"
              onChange={(e) =>
                (updatedVehicleInfo.rentalPrice = e.target.value)
              }
              autoComplete="off"
            />
          </td>
          ...
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.year}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="year"
              onChange={(e) => (updatedVehicleInfo.year = e.target.value)}
              autoComplete="off"
            />
          </td>
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.licensePlate}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="licensePlate"
              onChange={(e) =>
                (updatedVehicleInfo.licensePlate = e.target.value)
              }
              autoComplete="off"
            />
          </td>
          <td className="fieldInputs">
            <input
              type="text"
              placeholder={vehicleInfo.color}
              className="inputBoxes"
              form={vehicleInfo._id}
              name="color"
              onChange={(e) => (updatedVehicleInfo.color = e.target.value)}
              autoComplete="off"
            />
          </td>
          <td className="fieldInputs">
            ...
            >
              <option value="65fb731318f6999f70da4432">
                CarsRUS: Downtown Montreal
              </option>
              <option value="65fb739018f6999f70da4433">
                CarsRUs: Montreal West
              </option>
              <option value="65fb73e818f6999f70da4435">CarsRUs: YUL</option>
              <option value="65fb740418f6999f70da4437">CarsRUs: YYZ</option>
              <option value="65fb741518f6999f70da4438">
                CarsRUs: King Street
              </option>
              <option value="65fb742518f6999f70da4439">
                CarsRUs: Dundas East
              </option>
            </select>
          </td>
          <td className="confirmation">
            ...
            <button
              ...
              id="deleteButton"
              form={vehicleInfo._id}
              onClick={() => deleteVehicle(vehicleInfo)}
            >
              Delete
            </button>
          </td>
  ...
  return (
    <>
      ...
      <button className="LogBtn" onClick={toggleCreateVehicleModal}>
        Create Vehicle
      </button>
      ...
      {createVehicleModal && (
        <>
          ...
          <div className="modal-content2">
            <CreateVehicle toggleModal={toggleCreateVehicleModal} />
          </div>
        </>
      )}
    </>
