...
export default function CheckoutRedirect() {
  ...
  function handleCheckoutConfirmation(trait: string) {
    ...
    axios
      .post("http://localhost:8080/CreateCheckout", {
      ...
      <div className="checkoutFormContainer">
        ...
        <div className="traitContainer">
          ...
          <div className="description">
            Welcome to the checkout process! As you prepare to complete your
            rental, we kindly ask for your assistance in verifying the condition
            of the vehicle. Below, you'll find a list of traits related to the
            car's condition. Please review each trait carefully and indicate
            whether it applies to the vehicle you're returning by selecting
            "Yes".
          </div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    onClick={() => handleCheckoutConfirmation("Light Scratch")}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    onClick={() => handleCheckoutConfirmation("Medium Scratch")}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    onClick={() => handleCheckoutConfirmation("Large Scratch")}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    onClick={() =>
                      handleCheckoutConfirmation("Interior Damage")
                    }
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    onClick={() =>
                      handleCheckoutConfirmation("Unclean Interior")
                    }
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    onClick={() => handleCheckoutConfirmation("Eq Ac")}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    type="checkbox"
                    onClick={() => handleCheckoutConfirmation("Late Return")}
                  />
                </td>
              </tr>
            </tbody>
        ...
        <div className="signature">
          ...
          <div>
            By signing below, the customer takes the responsibility for any kind
            of damage to checked out vehicle and acknowledges that the vehicle
            is working properly and in a good condition. For any damage, the
            customer accepts to cover the cost of damage to the vehicle.
          </div>
          E-signature:
          <input type="signature" />
          <br />
          <button className="coBtn" onClick={handleCheckout}>
            Check Out
          </button>
        </div>
      </div>

      <div className="confirmButtonContainer"></div>
    </>
  );
}
