...
function RentalAgreement() {
  ...
  useEffect(() => {
    ...
    if (current_userId) {
      axios
        .post(`http://localhost:8080/users/${current_userId}`)
        .then((userResponse) => {
      ...
      <div className="body">
        ...
        <div className="box">
          <p>
            ...
            {reservationData ? reservationData.userId : "loading..."} <br />
            <br />
            This Rental Agreement ("Agreement") is entered into between{" "}
            {fullname}, located at{" "}
            {reservationData ? reservationData.location : "loading..."} ,
            hereinafter referred to as the "Rental Company," and the individual
            or entity identified below, hereinafter referred to as the "Renter":
          </p>
          <ol type="1">
            {userData && (
              <>
            ...
            {carData && (
              <>
                ...
                <p>
                  ...
                  Vehicle Identification Number (VIN): {reservationData?.carId}
                  <br />
            ...
            {reservationData && (
              <>
                ...
                <p>
                  ...
                  {formatDateTime(reservationData.reservationDate)} <br />
                  Rental End Date and Time:{" "}
                  {formatDateTime(reservationData.returnDate)} <br />
                  Pick-up Location: {reservationData.location} <br />
                  Drop-off Location: {reservationData.returnLocation} <br />
                  Rental Period: {rentalPeriod.days} days, {rentalPeriod.hours}{" "}
                  hours, {rentalPeriod.minutes} minutes <br />
            ...
            <ul style={{ listStyleType: "disc" }}>
              <p>
                <li>
                  ...
                  in good condition and agrees to return it to the Rental
                  Company in the same condition, subject to normal wear and
                  tear.
                </li>
                <li>
                ...
                <li>
                  ...
                  rental rate for the specified rental period. Additional
                  charges may apply for exceeding the mileage limit, late
                  returns, fuel refueling, or other damages.
                </li>
                <li>
                  The Renter agrees to bear all costs associated with traffic
                  violations, tolls, and parking fines incurred during the
                  rental period.
                </li>
                <li>
                  The Renter acknowledges that they are responsible for any loss
                  or damage to the vehicle, including theft, vandalism,
                  accidents, or negligence, and agrees to reimburse the Rental
                ...
                <li>
                  ...
                  agreement and repossess the vehicle without prior notice if
            ...
            <p>
              The Renter agrees to indemnify and hold harmless the Rental
              Company, its employees, agents, and affiliates from any claims,
              liabilities, damages, or expenses arising out of or related to the
            ...
            <p>
              ...
              with the laws of{" "}
              {reservationData ? reservationData.location : "loading..."}. Any
              disputes arising under or related to this Agreement shall be
              resolved exclusively by the courts of{" "}
              {reservationData ? reservationData.location : "loading..."}.
            </p>
