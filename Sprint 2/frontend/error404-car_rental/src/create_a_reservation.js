...
const CarRentalReservation = () => {
  return (
    <div className='background_reserve'>
      ...
      <img src='https://robbreport.com/wp-content/uploads/2019/03/18c0771_007.jpg?w=1000' alt="car"></img>
      <form action="/payment">
        <table>
            <tr>
              <th>First Name:</th>
            ...
            <tr>
              <th>Pickup Date: </th>
              <td><input type="date" min={getCurrentDate()} className='outlined_fields' required /></td>
            </tr>
            <br />
            <tr>
              <th>Return Date: </th>
